turtles-own [boldness vengefulness meta-vengefulness utility]

to setup
  clear-all
  crt 100 [
    set boldness random 8 ; stick with Axelrod's initial specification
    set vengefulness random 8 ; ditto
    set meta-vengefulness vengefulness ; setting up for some variation in the next version.
